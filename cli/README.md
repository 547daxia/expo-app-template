...
📱 A template for your next React Native project 🚀, Made with developer experience and performance first: Expo, TypeScript, TailwindCSS, Husky, Lint-Staged, Expo Router, TanStack Query, and TanStack Form.
...
- ✅ Expo SDK 56, along with the Custom Dev Client, to give you access to Expo APIs and native dependencies.
- 🎉 [TypeScript](https://www.typescriptlang.org/) for type checking, to help you catch bugs and improve code quality.
- 💅 A minimal UI kit built with [Uniwind](https://github.com/uni-stack/uniwind) and TailwindCSS, which provides a range of pre-defined classes for styling your app.
- ⚙️ Support for multiple environment builds, including Production, Preview, and Development, using Expo configuration.
...
- 🧵 A good approach for handling forms with [TanStack Form](https://tanstack.com/form/latest) and [zod](https://zod.dev/) for validation + keyboard handling.
